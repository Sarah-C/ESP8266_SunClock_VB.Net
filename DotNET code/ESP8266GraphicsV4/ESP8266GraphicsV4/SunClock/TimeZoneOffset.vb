Public Class TimeZoneOffset
    ...
    Public Shared locations As New Dictionary(Of String, Integer) From {
        {"Africa/Abidjan", 0},
        {"Africa/Accra", 0},
    ...
    Public Shared lowerLocations = New Dictionary(Of String, Integer)(locations, StringComparer.OrdinalIgnoreCase)

    Public Shared Function getInMinutes(ByVal location As String) As Integer
        Dim timeOffset As Integer = 0
        lowerLocations.TryGetValue(location, timeOffset)
        Return timeOffset
    End Function
